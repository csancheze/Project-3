...
function SignupFormUser() {
  ...
  <form className="col-10 col-sm-5 border rounded-3 p-3 signup-user">
...
<img className='col-12 col-sm-6' id="background-signup" src={require('../images/blake.jpg')} alt="background" />
    </div>
  )
}
